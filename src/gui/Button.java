...
public class Button extends UIComponent{
	...
	public void update(BSInputHandler input){
		...
		Rectangle butt = new Rectangle((int) (position.x * GameDisplay.MAX_WIDTH / GameDisplay.SCALE), (int) (position.y * GameDisplay.MAX_HEIGHT / GameDisplay.SCALE), width, height);//-1-3
